...
if(isset($_POST['submit'])){
	...
	// Cette fonction est utilisée pour créer une chaîne SQL valide qui pourra être utilisée dans une requête SQL.
	//  La chaîne de caractères escapestr est encodée en une chaîne SQL échappée,
